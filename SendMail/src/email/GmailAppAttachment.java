...
import javax.mail.internet.MimeMultipart;
	...
	public class GmailAppAttachment {
	 
		public static  void sendMail(String recipient) throws Exception{
			
			System.out.println("------------------Perparing to send email with attachment----------------------");
			...
			String myAccount = "ronykhurd@gmail.com";
			String myPassword = "Notebook1";
		...
		public static Message prepareMessage(Session session,String myAccount,String recipient) throws IOException{
	        ...
	        try {
				...
				message.setSubject("Sending my first message with attachment from gmail");
