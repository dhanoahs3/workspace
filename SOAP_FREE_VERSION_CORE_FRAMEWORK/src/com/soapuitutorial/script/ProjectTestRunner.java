...
public class ProjectTestRunner {
	...
	public static void main(String[]args) throws IOException{
		...
		String resultFilePathFolder = Constants.PROJECT_PATH+"\\excelreports\\";
		...
		XLUtil.prepareResultSheet("C:\\testing\\Soap reporting\\Test Data.xlsx",resultFilePathFolder);
		...
		for(int tsId=0; tsId<allTestSuite.size();tsId++){
			...
			for(int tcId=0;tcId<allTestCases.size();tcId++){
				...
				if(XLUtil.isExectuable(testCaseName, xls,"Test Cases")){
